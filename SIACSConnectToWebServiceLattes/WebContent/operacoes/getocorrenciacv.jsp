...
<title>getOcorrenciaCV</title>
</head>

<body>

<form name="getOcorrenciaCV" method="post" action="/SIACSConnectToWebServiceLattes/SIACSServlet">
	Id:<br>
	<input type="text" name="frm_id"><br>

	<input type="submit" name="Submit" value="Enviar" />
	<input type="hidden" name="cmd" value="GetOcorrenciaCV" />
    <input type="hidden" name="page" value="operacoes/getocorrenciacv.jsp" />	
