...
<title>getDataAtualizacaoCVPorUsuario</title>
</head>

<body>

<form name="getDataAtualizacaoCVPorUsuario" method="post" action="/SIACSConnectToWebServiceLattes/SIACSServlet">
	Id:<br>
	...
	<input type="hidden" name="cmd" value="GetDataAtualizacaoCVPorUsuario" />
    <input type="hidden" name="page" value="operacoes/getdataatualizacaocvporusuario.jsp" />	
